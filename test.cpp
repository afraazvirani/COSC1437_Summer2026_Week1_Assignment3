...
int main()
{
    ...
    {
        cout << "The first character is neither a digit or a letter" << endl;
    }

    getline(cin, userInput);

    cout << "The sentence you entered is: " << userInput << endl;

    // putback() is used to return the character that was read back into the original sentence so the sentence can be used for further operations
    ...
    cout << "The integer you entered is: " << userInteger << endl;
    cout << "The sentence you entered is: " << userDescription << endl;
